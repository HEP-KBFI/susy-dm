...
!      WRITE(17,*)
     ...
     .        "g1(MLANDAU), (GUT normalization)"
      ...
      WRITE(17,899) "# "
      WRITE(17,899) "# FINE-TUNING parameter d(ln Mz^2)/d(ln PM^2)"
      WRITE(17,902) 1,FTMES(1),"PM=MSUSYEFF"
      WRITE(17,902) 2,FTMES(2),"PM=MS"
      WRITE(17,902) 3,FTMES(3),"PM=DELTA_H"
      WRITE(17,902) 4,FTMES(4),"PM=ALAMBDA"
      WRITE(17,902) 5,FTMES(5),"PM=XIF"
      WRITE(17,902) 6,FTMES(6),"PM=XIS"
      WRITE(17,902) 7,FTMES(7),"PM=MUP"
      WRITE(17,902) 8,FTMES(8),"PM=MSP"
      WRITE(17,902) 9,FTMES(9),"PM=LAMBDA"
      WRITE(17,902) 10,FTMES(10),"PM=KAPPA"
      WRITE(17,902) 11,FTMES(11),"PM=HTOP"
      WRITE(17,902) 12,FTMES(12),"PM=G1"
      WRITE(17,902) 13,FTMES(13),"PM=G2"
      WRITE(17,902) 14,FTMES(14),"PM=G3"
      WRITE(17,902) 15,FTMES(15),"PM=MMES"
      WRITE(17,902) 16,FTMES(16),"MAX"
