...
************************************************************************
      ...
      INTEGER I,J,FLAG,M1FLAG,M2FLAG,M3FLAG,MHDFLAG
      INTEGER MHUFLAG,AKFLAG,ALFLAG,NSUSY,NGUT,NMES
      ...
      DOUBLE PRECISION HTMES,HBMES,HLMES      
...
*   MES scale parameters
     ...
     .  FTSUSY(12)=PS(12)/K*FTSUSY(12)
      ...
      INTEGER I,IFAIL,M,N,M1,M2,M3,MHD,MHU,AK,AL,NN
      PARAMETER (NN=35)
      ...
      COMMON/RENSCALE/Q2
      COMMON/SCANFLAGS/M1,M2,M3,MHD,MHU,AK,AL
