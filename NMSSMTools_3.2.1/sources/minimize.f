...
**********************************************************************
      ...
      DOUBLE PRECISION B,MUOLD,KOLD,MSSOLD,XISOLD
...
* If MU and K are input parameters MH1Q and MH2Q are computed
...
* If MAFLAG=-1 compute MSSX = MS at QSTSB then MSS = MS at Q2
