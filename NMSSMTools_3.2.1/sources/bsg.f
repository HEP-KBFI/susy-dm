...
*
* [20] LHCb constraints on B_s -> mu mu, LHCb-PAPER-2012-007
...
*      From [20]: BR(Bs->mu+mu-) < 4.5 10^-9 (95% C.L.)
...
*      Comparison with experimental data ([20])
*    (Recall: BRBMUMUexpmax=4.5d-9 at 95% CL)
