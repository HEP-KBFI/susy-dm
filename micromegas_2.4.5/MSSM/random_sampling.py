...
def main():
  ...
  for n in range(N):
    s = f(v)
    print s["tb"], s["Mtp"], s["MbMb"], s["alfSMZ"], s["sgn"], s["gMG1"], s["gMG2"], s["gMG3"], s["gAl"], s["gAt"], s["gAb"], s["gMHu"], s["gMHd"], s["gMl2"], s["gMl3"], s["gMr2"], s["gMr3"], s["gMq2"], s["gMq3"], s["gMu2"], s["gMu3"], s["gMd2"], s["gMd3"]
